...
This is a sample template for rpi-measure - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name rpi-measure --query 'Stacks[].Outputs'
```
